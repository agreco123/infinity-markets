...
// v4.1 (V41-1): deepMergeNullWins moved to deliverables/helpers.js.
const SRC = path.join(__dirname, '..', 'routes', 'deliverables', 'helpers.js');
...
if (!m) {
  console.error('FAIL: could not locate deepMergeNullWins in deliverables/helpers.js');
  process.exit(1);
}
