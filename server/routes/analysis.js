...
router.post('/', async (req, res) => {
  ...
  // Don't hard-fail on null demographics — Claude can work with partial data
...
=== DEMOGRAPHICS ===
${demographics ? JSON.stringify(demographics, null, 2) : 'No demographic data available — use regional estimates for the Buffalo-Cheektowaga-Niagara Falls, NY MSA based on your knowledge.'}

=== HOUSING MARKET ===
${housing ? JSON.stringify(housing, null, 2) : 'No housing data available — use regional estimates based on your knowledge of the market.'}

=== COMPETITION ===
${competition ? JSON.stringify(competition, null, 2) : 'No competition data available — provide estimates based on typical WNY new construction activity.'}
