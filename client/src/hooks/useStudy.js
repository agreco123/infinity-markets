  ...
  const run = useCallback(async (query) => {
    ...
    try {
      ...
      if (housingData && demoData) {
        ...
        // v2.3: Surface ACS tenure counts on housing so Section 4 KPIs render
        ...
        // Replace Redfin "active for-sale inventory" with ACS housing stock count for Section 4 "Total Units" KPI
